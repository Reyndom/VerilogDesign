...
#
# Script generated by Vivado on Thu Oct 31 14:15:10 +0700 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : design_1_wrapper.sh
...
#
# Usage        : design_1_wrapper.sh
#                design_1_wrapper.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                design_1_wrapper.sh [-reset_run]
#                design_1_wrapper.sh [-reset_log]
#                design_1_wrapper.sh [-help]
#
...
#                script (type 'design_1_wrapper.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname axi_infrastructure_v1_1_0 -libname axi_vip_v1_1_17 -libname zynq_ultra_ps_e_vip_v1_0_17 -libname xil_defaultlib -libname axi_lite_ipif_v3_0_4 -libname lib_cdc_v1_0_3 -libname interrupt_control_v3_1_5 -libname axi_gpio_v2_0_33 -libname generic_baseblocks_v2_1_2 -libname axi_register_slice_v2_1_31 -libname fifo_generator_v13_2_10 -libname axi_data_fifo_v2_1_30 -libname axi_crossbar_v2_1_32 -libname axi_protocol_converter_v2_1_31 -libname axi_clock_converter_v2_1_30 -libname blk_mem_gen_v8_4_8 -libname axi_dwidth_converter_v2_1_31 -libname proc_sys_reset_v5_0_15 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm axi_infrastructure_v1_1_0 axi_vip_v1_1_17 zynq_ultra_ps_e_vip_v1_0_17 xil_defaultlib axi_lite_ipif_v3_0_4 lib_cdc_v1_0_3 interrupt_control_v3_1_5 axi_gpio_v2_0_33 generic_baseblocks_v2_1_2 axi_register_slice_v2_1_31 fifo_generator_v13_2_10 axi_data_fifo_v2_1_30 axi_crossbar_v2_1_32 axi_protocol_converter_v2_1_31 axi_clock_converter_v2_1_30 blk_mem_gen_v8_4_8 axi_dwidth_converter_v2_1_31 proc_sys_reset_v5_0_15)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "design_1_wrapper.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./design_1_wrapper.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../hello_world.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../hello_world.gen/sources_1/bd/design_1/ipshared/a317/hdl" +incdir+"D:/VIVADO/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../hello_world.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../hello_world.gen/sources_1/bd/design_1/ipshared/a317/hdl" +incdir+"D:/VIVADO/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../hello_world.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../hello_world.gen/sources_1/bd/design_1/ipshared/a317/hdl" +incdir+"D:/VIVADO/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../hello_world.gen/sources_1/bd/design_1/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_vip_v1_1_17 $xmvlog_opts -sv +incdir+"../../../hello_world.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../hello_world.gen/sources_1/bd/design_1/ipshared/a317/hdl" +incdir+"D:/VIVADO/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../hello_world.gen/sources_1/bd/design_1/ipshared/4d04/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work zynq_ultra_ps_e_vip_v1_0_17 $xmvlog_opts -sv +incdir+"../../../hello_world.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../hello_world.gen/sources_1/bd/design_1/ipshared/a317/hdl" +incdir+"D:/VIVADO/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../hello_world.gen/sources_1/bd/design_1/ipshared/a317/hdl/zynq_ultra_ps_e_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../hello_world.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../hello_world.gen/sources_1/bd/design_1/ipshared/a317/hdl" +incdir+"D:/VIVADO/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work generic_baseblocks_v2_1_2 $xmvlog_opts +incdir+"../../../hello_world.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../hello_world.gen/sources_1/bd/design_1/ipshared/a317/hdl" +incdir+"D:/VIVADO/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../hello_world.gen/sources_1/bd/design_1/ipshared/0c28/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_register_slice_v2_1_31 $xmvlog_opts +incdir+"../../../hello_world.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../hello_world.gen/sources_1/bd/design_1/ipshared/a317/hdl" +incdir+"D:/VIVADO/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../hello_world.gen/sources_1/bd/design_1/ipshared/92b2/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work fifo_generator_v13_2_10 $xmvlog_opts +incdir+"../../../hello_world.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../hello_world.gen/sources_1/bd/design_1/ipshared/a317/hdl" +incdir+"D:/VIVADO/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_data_fifo_v2_1_30 $xmvlog_opts +incdir+"../../../hello_world.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../hello_world.gen/sources_1/bd/design_1/ipshared/a317/hdl" +incdir+"D:/VIVADO/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../hello_world.gen/sources_1/bd/design_1/ipshared/9692/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_crossbar_v2_1_32 $xmvlog_opts +incdir+"../../../hello_world.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../hello_world.gen/sources_1/bd/design_1/ipshared/a317/hdl" +incdir+"D:/VIVADO/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_protocol_converter_v2_1_31 $xmvlog_opts +incdir+"../../../hello_world.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../hello_world.gen/sources_1/bd/design_1/ipshared/a317/hdl" +incdir+"D:/VIVADO/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../hello_world.gen/sources_1/bd/design_1/ipshared/3c06/hdl/axi_protocol_converter_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_clock_converter_v2_1_30 $xmvlog_opts +incdir+"../../../hello_world.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../hello_world.gen/sources_1/bd/design_1/ipshared/a317/hdl" +incdir+"D:/VIVADO/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../hello_world.gen/sources_1/bd/design_1/ipshared/80bf/hdl/axi_clock_converter_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work blk_mem_gen_v8_4_8 $xmvlog_opts +incdir+"../../../hello_world.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../hello_world.gen/sources_1/bd/design_1/ipshared/a317/hdl" +incdir+"D:/VIVADO/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../hello_world.gen/sources_1/bd/design_1/ipshared/09bd/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_dwidth_converter_v2_1_31 $xmvlog_opts +incdir+"../../../hello_world.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../hello_world.gen/sources_1/bd/design_1/ipshared/a317/hdl" +incdir+"D:/VIVADO/Vivado/2024.1/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.design_1_wrapper xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.design_1_wrapper -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log design_1_wrapper_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./design_1_wrapper.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: design_1_wrapper.sh [-help]\n\
Usage: design_1_wrapper.sh [-step]\n\
Usage: design_1_wrapper.sh [-lib_map_path]\n\
Usage: design_1_wrapper.sh [-reset_run]\n\
Usage: design_1_wrapper.sh [-reset_log]\n\
Usage: design_1_wrapper.sh [-keep_index]\n\
Usage: design_1_wrapper.sh [-noclean_files]\n\n\
