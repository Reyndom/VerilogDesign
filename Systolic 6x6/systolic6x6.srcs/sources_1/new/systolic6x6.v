module systolic6x6 #(
    ...
    input wire signed [WIDTH-1:0] b00,b01,b02,b03,b04,b05,b10,b11,b12,b13,b14,b15,b20,b21,b22,b23,b24,b25,
    ...
    wire signed [WIDTH-1:0] a00_out, a10_out, a11_out, a20_out, a21_out, a22_out, a30_out, a31_out, a32_out, a33_out,
    a40_out, a41_out, a42_out, a43_out, a44_out, a50_out, a51_out, a52_out, a53_out, a54_out, a55_out;
    wire signed [WIDTH-1:0] y00_out, y01_out, y02_out, y03_out, y04_out, y05_out, y10_out, y11_out, y12_out, y13_out, y14_out,
    y20_out, y21_out, y22_out, y23_out, y30_out, y31_out, y32_out, y40_out, y41_out, y50_out;
    wire signed [WIDTH-1:0] b00_a0_out, b01_a0_out, b02_a0_out, b03_a0_out, b04_a0_out,
    b10_a1_out, b11_a1_out, b12_a1_out, b13_a1_out, b14_a1_out, b20_a2_out, b21_a2_out, b22_a2_out, b23_a2_out, b24_a2_out,
    b30_a3_out, b31_a3_out, b32_a3_out, b33_a3_out, b34_a3_out, b40_a4_out, b41_a4_out, b42_a4_out, b43_a4_out, b44_a4_out,
    ...
    b10_y0_out, b11_y1_out, b12_y2_out, b13_y3_out, b14_y4_out, b15_y5_out, b20_y0_out, b21_y1_out, b22_y2_out, b23_y3_out, b24_y4_out, b25_y5_out,
    b30_y0_out, b31_y1_out, b32_y2_out, b33_y3_out, b34_y4_out, b35_y5_out, b40_y0_out, b41_y1_out, b42_y2_out, b43_y3_out, b44_y4_out, b45_y5_out;
    wire signed [WIDTH-1:0] b00_a, b01_a, b02_a, b03_a, b04_a, b05_a, b10_a, b11_a, b12_a, b13_a, b14_a, b15_a,
    b20_a, b21_a, b22_a, b23_a, b24_a, b25_a, b30_a, b31_a, b32_a, b33_a, b34_a, b35_a,
    b40_a, b41_a, b42_a, b43_a, b44_a, b45_a, b50_a, b51_a, b52_a, b53_a, b54_a, b55_a;
    wire signed [WIDTH-1:0] b00_y, b01_y, b02_y, b03_y, b04_y, b05_y, b10_y, b11_y, b12_y, b13_y, b14_y, b15_y,
    b20_y, b21_y, b22_y, b23_y, b24_y, b25_y, b30_y, b31_y, b32_y, b33_y, b34_y, b35_y,
    b40_y, b41_y, b42_y, b43_y, b44_y, b45_y, b50_y, b51_y, b52_y, b53_y, b54_y, b55_y;
    ...
    // Register y
    // Register y0
    register #(.WIDTH(WIDTH)) y00 (.clk(clk), .rst_n(rst_n), .en(en), .clr(clr), .d(b50_y), .q(y00_out));
    ...
    // Register y1
    register #(.WIDTH(WIDTH)) y10 (.clk(clk), .rst_n(rst_n), .en(en), .clr(clr), .d(b51_y), .q(y10_out));
    ...
    // Register y2
    register #(.WIDTH(WIDTH)) y20 (.clk(clk), .rst_n(rst_n), .en(en), .clr(clr), .d(b52_y), .q(y20_out));
    ...
    // Register y3
    register #(.WIDTH(WIDTH)) y30 (.clk(clk), .rst_n(rst_n), .en(en), .clr(clr), .d(b53_y), .q(y30_out));
    ...
    // Register y4
    register #(.WIDTH(WIDTH)) y40 (.clk(clk), .rst_n(rst_n), .en(en), .clr(clr), .d(b54_y), .q(y40_out));
    register #(.WIDTH(WIDTH)) y41 (.clk(clk), .rst_n(rst_n), .en(en), .clr(clr), .d(y40_out), .q(y4));
    // Register y5
    register #(.WIDTH(WIDTH)) y50 (.clk(clk), .rst_n(rst_n), .en(en), .clr(clr), .d(b55_y), .q(y5));
