...
HD_PWD='D:/Coolyeah/Semester 7/MSIB 7/Polytron/Tugas Pak Sutisna/Systolic 6x6/systolic6x6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log systolic6x6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source systolic6x6.tcl
