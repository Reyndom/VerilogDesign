...
HD_PWD='D:/Coolyeah/Semester 7/MSIB 7/Polytron/Tugas Pak Sutisna/PE_Desain/PE.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log register.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source register.tcl
